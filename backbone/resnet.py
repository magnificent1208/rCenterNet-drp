...
# 这个heads是output数
def ResNet(layer_num, heads = {'hp_offset':2, 'hm': 1, 'wh': 2, 'reg': 2}, head_conv=256, plot=False):
# def ResNet(layer_num, heads = {'hp':1, 'hm': 1, 'wh': 2, 'ang':1, 'reg': 2}, head_conv=256, plot=False):
